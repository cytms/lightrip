          ...
          for (var i = 0; i < origins.length; i++) {
            ...
            for (var j = 0; j < results.length; j++) {
             ...
             /*duration.value (in seconds)*/ 
              outputDiv.innerHTML += "<div onclick='change_to_driving(\""+ id +"\");'>walking</div>"+"<div class='distance' style='display:none;'>" + results[j].distance.text + "</div>" +"<div class='duration'>"+ results[j].duration.text + "</div>" +"<div class='duration_value' style='display:none;'>"+ results[j].duration.value + "</div>";
