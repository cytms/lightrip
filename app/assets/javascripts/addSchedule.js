function addSchedule(){ 
	...
	if (find !=1){
	    ...
	    $('#mySchedule').append('<li class="block spotinfo" id="'+newSpotID+'" name="'+newSpotName+'" zoom="1.0" lat="'+newSpotLat+'" lon="'+newSpotLon+'" address="'+newSpotAddress+'" info="'+newSpotText+'" spotin = "1" style="z-index: 3; "><div class="left"><img src="'+newSpotImg+'"></div><div class="right"><a href="javascript:lightbox(\''+newSpotName+'\')">'+newSpotName+'</a><div class="travel_time_space"><div class="travel_time_content">4hr</div></div></div></li>')
		if(size > 0){
